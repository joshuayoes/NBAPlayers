...
// #region Components
const PlayerIcon = observer(function PlayerIcon({ player }: { player: Player }) {
  const backupUri =
...
const PlayerCard = observer(function PlayerCard({ player, team }: { player: Player; team: Team }) {
